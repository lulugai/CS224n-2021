...
def negSamplingLossAndGradient(
    ...
    gradOutsideVecs[outsideWordIdx] += (score_o - 1) * centerWordVec
    ...
    for i, negSampleWordIndice in enumerate(negSampleWordIndices):
        gradOutsideVecs[negSampleWordIndice] += (1 - score_k[i]) * centerWordVec
