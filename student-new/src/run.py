...
print('torch:{} device:{}'.format(torch.__version__, device))
...
if args.variant == 'vanilla':
    model = model.GPT(mconf).to(device)# TODO [part c]: Make some model here
elif args.variant == 'synthesizer':
    mconf.synthesizer = True
    model = model.GPT(mconf).to(device)  # TODO [part g]: Make some other model here
...
if args.function == 'pretrain':
    ...
    finetune_dataset = dataset.NameDataset(pretrain_dataset, text)#(x,y)
